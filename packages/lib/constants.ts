...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://booking.buraq.ai";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "booking.buraq.ai";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "booking@buraq.ai";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "booking.buraq.ai, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "booking.buraq.ai";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "booking.buraq.ai";
...
export const FAVICON_16 = "/buraq-logo-16x16.png";
export const FAVICON_32 = "/buraq-logo-32x32.png";
export const APPLE_TOUCH_ICON = "/apple-touch-icon.png";
export const MSTILE_ICON = "/mstile-150x150.png";
export const ANDROID_CHROME_ICON_192 = "/buraq-logo-192x192.png";
export const ANDROID_CHROME_ICON_256 = "buraq-logo-256x256.png";
...
export const WEBSITE_PRIVACY_POLICY_URL = process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://booking.buraq.ai/privacy";
// export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://cal.com/terms";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "booking.buraq.ai/terms";
